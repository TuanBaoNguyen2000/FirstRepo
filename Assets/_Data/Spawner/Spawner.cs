...
public abstract class Spawner : MyMonoBehaviour
{
    ...
    [SerializeField] protected int enemyDeathCount = 0;
    ...
    public virtual Transform RandomPrefab()
    {
        ...
        if (this.enemyDeathCount == 30 || this.enemyDeathCount == 60) return this.GetPrefabByName("Boss");

        if (this.enemyDeathCount > 100)
        {
        ...
        {
            rand = Random.Range(0, this.prefabs.Count);
        } while (this.prefabs[rand].name == "Boss");
        return this.prefabs[rand];
    }
}
